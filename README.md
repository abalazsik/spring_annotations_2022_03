...
Egy export a Spring-es jegyzeteim közül amit az elmúl években írtam. A fontosabb annotációkat tartalmazza. Hátha valakinek hasznos lesz...
...
Aliasok létrehozásához. (Saját annotációknál). Ha például egy mezőt többféle képpen is nevezhetünk egy annotációban akkor ennek segítségével lehet ezt deiniálni  
...
min: osztályra (@Configuration-nal)  
...
min: metódus definicióra(interfészben)  
...
min: oszályra (AuthServerOAuth2Config leszármazott)  
...
Konfigurációs osztályra. Metódus szinten határozhatjuk meg a Security-t vele. (A EnableWebFluxSecurity ellentétben, ami apath szinten megy)  
...
Konfigurációs osztályra. Engedélyezzük vele a WebFlux Security-t  
